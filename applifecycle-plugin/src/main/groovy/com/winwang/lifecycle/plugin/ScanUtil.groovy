...
class ScanUtil {
    ...
    //com.winwang.applifecycle.apt.proxy
    static final PROXY_CLASS_PACKAGE_NAME = "com/winwang/applifecycle/apt/proxy"

    static final REGISTER_CLASS_FILE_NAME = "com/winwang/api/AppLifecycleManager.class"

    //包含生命周期管理初始化类的文件，及包含 com.winwang.api.AppLifecycleManager 类的class文件或者jar文件
